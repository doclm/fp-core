...
var ProbabilityFlags = require('./culture').ProbabilityFlags;
var Desires = require('./desires').Desires;
var Plans = require('./plans').Plans;
...
//                    }
    ...
    this.executePlan = function(world) {
        ...
        this.moveTo(point[0], point[1], world);
