...
var Catastrophe = require('./../../models/catastrophe').Catastrophe;
var ResourceCategory = require('./../../models/resource').ResourceCategory;
var World = require('./../../models/index').World;
var Terrain = require('./../../models/index').Terrain;
var Notice = require('./../../utils/notice').Notice;
var one = {};
...
//        this.world6.catastrophe = (new Catastrophe(TBL.ECO_CATEGORY, 500 + (Math.random() * 500), 250, 0.75, new Notice("The city is suffering a financial crisis - many services will be temporarily discontinued...", undefined, undefined, 500, 250, undefined, undefined, TBL.ECO_CATEGORY.color)));
        ...
        this.world11.setup = function() {
            ...
            if (! this.preState) {
                ...
                this.preState.capabilities = FiercePlanet.GameState.currentProfile.capabilities;
            }
            Universe.settings.ignoreResourceBalance = true;
            Universe.settings.useInlineResourceSwatch = false;
            Lifecycle.interval = 10;
            FiercePlanet.GameState.currentProfile.capabilities = FiercePlanet.Profile.GENIUS_CAPABILITIES;
        ...
        this.world11.teardown = function() {
            ...
            FiercePlanet.GameState.currentProfile.capabilities = this.preState.capabilities;
            FiercePlanet.GeneralUI.refreshSwatch();
        };
